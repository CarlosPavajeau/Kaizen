...
{
    public class OnUpdatedClient
    {
        public class Handler : INotificationHandler<DomainEventNotification<UpdatedClient>>
        {
            ...
            public Handler(INotificationsRepository notificationsRepository, IUnitWork unitWork,
