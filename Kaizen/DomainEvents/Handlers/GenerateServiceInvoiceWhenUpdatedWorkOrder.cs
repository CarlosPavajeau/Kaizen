...
{
    public class
        GenerateServiceInvoiceWhenUpdatedWorkOrder : INotificationHandler<DomainEventNotification<UpdatedWorkOrder>>
    {
        private readonly IServiceInvoicesRepository _serviceInvoicesRepository;
        private readonly IActivitiesRepository _activitiesRepository;
        private readonly IUnitWork _unitWork;

        public GenerateServiceInvoiceWhenUpdatedWorkOrder(IServiceInvoicesRepository serviceInvoicesRepository,
            IActivitiesRepository activitiesRepository, IUnitWork unitWork)
        {
